...
(function($){
  ...
  app.controller('tv-page', ['$scope', '$rootScope', '$http', '$mdToast', function($scope, $rootScope, $http, $mdToast) {
    ...
    $http.get('https://tv-v2.api-fetch.website/shows').success(function(data) {$scope.page["Search"]["Maximum"]=data.length;});
    ...
    $rootScope.$watch('searchedTVShows', function() {
      ...
      if(query.length != 0 && ($scope.lastsearch != query)) {
        ...
        function i() {
          $http.get('https://tv-v2.api-fetch.website/shows/'+$scope.page["Search"]["Current"]+'?keywords='+encodeURIComponent(query)).then(function successCallback(response) {
    ...
    $http.get('https://tv-v2.api-fetch.website/shows/1').success(function(data) {
    ...
    $scope.initiate = function(json) {
      ...
      $http.get('https://tv-v2.api-fetch.website/show/'+json.imdb_id).success(function(data1) {
        ...
        $http.get('https://tv-v2.api-fetch.website/show/'+json.imdb_id).success(function(data2) {
          $http.get('https://tv-v2.api-fetch.website/show/'+data2["id"]).success(function(data3) {
    ...
    $scope.more = function(actuallyIncrease) {
      if (actuallyIncrease) {
        $scope.page["Popular"]++;
        $http.get('https://tv-v2.api-fetch.website/shows/'+$scope.page["Popular"]).success(function(data) {
          var temp = [];
